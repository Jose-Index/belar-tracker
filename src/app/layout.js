  ...
  return (
    <html lang="es">
      <head>
        ...
        <link rel="icon" type="image/png" sizes="16x16" href="/icon-16.png?v=6" />
        <link rel="icon" type="image/png" sizes="32x32" href="/icon-32.png?v=6" />
        <link rel="icon" type="image/png" sizes="48x48" href="/icon-48.png?v=6" />
        <link rel="icon" type="image/png" sizes="64x64" href="/icon-64.png?v=6" />
        <link rel="icon" type="image/png" sizes="128x128" href="/icon-128.png?v=6" />
